    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center mx-auto mt-16'>
                ...
                <div className=''>
                    <div className='flex flex-col justify-center items-center bg-dark-200 w-52 sm:w-72 rounded-lg gap-3 sm:gap-[20px] p-6 relative'>
                        ...
                        >
                            <img className='w-6 h-6 sm:w-8 sm:h-8' src={isHovered ? FavoriteHover : Favorite} alt="icon favorite" />
                        </button>
                    </div>
                </div>
            </div>
